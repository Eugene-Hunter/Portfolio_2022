...
public class CustomerArchitectContractor {
	...
	public String toString() {
		String entity = "\tEntity Code\t\t: " + entityCode + "\n" 
					  + "\tName\t\t\t: " + entityName + "\n"
				      + "\tType\t\t\t: " + entityType + "\n";
	...
	public CustomerArchitectContractor(String entityCode, String entityName, String entityType){
